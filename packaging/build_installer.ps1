...
Write-Host "[5/7] Building standalone Windows application..."
...
Write-Host "[6/7] Compiling installer..."
$Candidates = @(
...
Write-Host "[7/7] Writing checksum metadata..."
